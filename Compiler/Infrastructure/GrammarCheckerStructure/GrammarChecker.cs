            ...
            foreach (var line in lines)
            {
                ...
                foreach (var a in line.Items)
                {
                    ...
                    if (a.Construction == "let" || a.Construction == "var" || a.Construction == "const")
                    {
                        if (array[0] != -1)
                        {
                            errors.Add(new ArgumentException("Непредвиденное ключевое слово " + a.Construction + " на позиции "+ a.From+":"+a.To));
                            continue;
                        }
                        else
                        {
                    ...
                    if (a.Code == "id")
                    {
                        if (array[1] != -1)
                        {
                            errors.Add(new ArgumentException("Непредвиденный идентификатор " + a.Construction + " на позиции " + a.From + ":" + a.To));
                            continue;
                        }
                        else
                        {
                    ...
                    if (a.Construction == "=")
                    {
                        if (array[2] != -1) errors.Add(new ArgumentException("Непредвиденное = " + a.Construction + " на позиции " + a.From + ":" + a.To));
                        else
                        {
                            array[2] = i;
                            i++;
                    ...
                    {
                        if (array[3] != -1) errors.Add(new ArgumentException("Непредвиденное значение " + a.Construction + " на позиции " + a.From + ":" + a.To));
                        else
                        {
                    ...
                    if (a.Construction == ";")
                    {
                        if (array[4] != -1) errors.Add(new ArgumentException("Непредвиденное ; " + a.Construction + " на позиции " + a.From + ":" + a.To));
                        else
                        {
                            array[4] = i;
                            i++;
                ...
                answer.Last().DeclorationErrors.AddRange(errors);
